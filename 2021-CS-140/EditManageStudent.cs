...
{
    public partial class EditManageStudent : Form
    {
        ...
        public EditManageStudent(string registrationNo,string firstName,string lastName,string contact,string email,string date,int gender)
        {
            InitializeComponent();
        ...
        private void EditManageAdvisor_Load(object sender, EventArgs e)
        {
            ...
            textBox2.Text = registrationNo.ToString();
            ...
            comboBox1.Text = gender.ToString();
        ...
        private void editStudentCloseBtn_Click_1(object sender, EventArgs e)
        {
            this.Close();
        }
    }
